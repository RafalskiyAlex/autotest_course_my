...
def repeats(our_str):
    """
    принимает на вход строку our_str, смотрит, сколько раз каждый символ уже встречался, и возвращает новую строку с
    количеством повторений через _n
    :param our_str:на вход строка
    :return: на выход новая строка с количеством повторений через _n
    """
    new_list = []
    str1 = ""
    dic = {}
